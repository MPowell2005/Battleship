...
Narrative:
    This program allows the user to play BattleShip against the computer with a variety of settings.
...
Features:
    ...
    - At the beginning of the game, the program prints the location of the player's ships, represented by emojis.
